...
export default function setup(options = {}) {
  ...
  return {
    /**
     * Fetch the active/specified index.html
     * from the bootstrap table of this project.
     * 
     * Setup the cache on first run, and make sure to use the
     * cache on subsequent requests. Also handle clearing the cache
     * via a subscription to PubSub, so that all clusteres are
     * prewarmed with the new index.html
     * 
     * @param {String} project The name of the project, used for cache and pubsub topic/subscription
